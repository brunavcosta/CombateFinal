...
static var instance = DAO()
    ...
    func criaHistorias() {
        ...
        let hist2 = Historia(nome: "Em Breve", image:"privacidade", resumo: " conhecimento do corpo humano de maneira didática e divertida, mostrando as partes do corpo, para que servem e para quem podemos mostrar.", pdf: "consfinal")
